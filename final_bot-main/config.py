...
TECHNIQUES = {
    "Water Breathing": [
        ...
        {"form": 5,  "name": "Blessed Rain",        "dmg_min": 40, "dmg_max": 54,  "sta_cost": 34, "type": "sustain",   "effect": "flow_sustain",
         "desc": "Self-heal, stamina recovery, and cleanses 1 bleed stack."},
        {"form": 6,  "name": "Whirlpool",           "dmg_min": 46, "dmg_max": 60,  "sta_cost": 40, "type": "control",   "effect": "flow_control",  "unlock_rank": "Kinoe",
         "desc": "Staggers 1 action; removes enemy dodge/escape capabilities."},
        {"form": 10, "name": "Constant Flux",       "dmg_min": 72, "dmg_max": 92,  "sta_cost": 60, "type": "finisher",  "effect": "flow_finisher", "unlock_rank": "Hashira",
    ...
    "Flame Breathing": [
        ...
        {"form": 3, "name": "Blazing Universe",          "dmg_min": 42, "dmg_max": 58,  "sta_cost": 25, "type": "mid_burst", "effect": "burn_burst",
         "desc": "Higher crit pressure if used after another Flame form."},
        {"form": 4, "name": "Blooming Flame Undulation", "dmg_min": 52, "dmg_max": 68,  "sta_cost": 30, "type": "punish",    "effect": "burn_punish",   "unlock_rank": "Kinoe",
         "desc": "Removes combo stack; reduces next incoming attack dmg by 20%."},
        {"form": 9, "name": "Rengoku",                   "dmg_min": 84, "dmg_max": 102, "sta_cost": 65, "type": "finisher",  "effect": "burn_execute",  "unlock_rank": "Hashira",
    ...
    "Blood Whip": [
        ...
        {"form": 2, "name": "Crimson Cage",    "dmg_min": 40, "dmg_max": 54, "sta_cost": 24, "type": "trap",     "effect": "bleed_extend",
         "desc": "+1 Bleed stack; extends bleed duration; halves enemy dodge/escape."},
        {"form": 3, "name": "Scarlet Torrent", "dmg_min": 56, "dmg_max": 74, "sta_cost": 38, "type": "finisher", "effect": "bleed_payoff",
    ...
    # ── NEW DEMON ARTS ────────────────────────────────────────────────────
    "Ice Manipulation": [
        {"form": 1,  "name": "Frost Strike",              "dmg_min": 45,  "dmg_max": 62,  "sta_cost": 18,  "effect": "freeze_apply"},
        {"form": 2,  "name": "Ice Lance Barrage",         "dmg_min": 55,  "dmg_max": 73,  "sta_cost": 24,  "hits": 2},
        {"form": 3,  "name": "Glacier Crush",             "dmg_min": 68,  "dmg_max": 88,  "sta_cost": 32,  "effect": "freeze_apply"},
        {"form": 4,  "name": "Absolute Zero Field",       "dmg_min": 88,  "dmg_max": 112, "sta_cost": 50,  "unlock_rank": "Lower Moon 3"},
        {"form": 5,  "name": "Crystal Lotus Bloom",       "dmg_min": 75,  "dmg_max": 95,  "sta_cost": 42,  "effect": "ice_shatter",  "desc": "AOE — Reduces enemy DEF by 15 for 3 turns"},
        {"form": 6,  "name": "Blizzard Veil",             "dmg_min": 40,  "dmg_max": 55,  "sta_cost": 38,  "effect": "ice_blind",    "desc": "30% chance enemy misses next physical attack"},
        {"form": 7,  "name": "Frozen Spine Impalement",   "dmg_min": 92,  "dmg_max": 118, "sta_cost": 55,  "effect": "ice_bleed",    "desc": "Bleed: 12 DOT for 2 turns"},
        {"form": 8,  "name": "Arctic Soul Devourer",      "dmg_min": 110, "dmg_max": 135, "sta_cost": 70,  "effect": "frostburn",    "desc": "Frostburn: drains 10 STA/turn", "unlock_rank": "Upper Moon 6"},
        {"form": 9,  "name": "Mirror of the Ice Queen",   "dmg_min": 125, "dmg_max": 150, "sta_cost": 85,  "effect": "ice_counter",  "desc": "Reflects 20% incoming DMG for 1 turn"},
        {"form": 10, "name": "Permafrost Calamity",       "dmg_min": 160, "dmg_max": 210, "sta_cost": 115, "effect": "deep_freeze",  "desc": "Deep Freeze: skip next 2 enemy turns (100%)", "unlock_rank": "Upper Moon 4"},
        {"form": 11, "name": "Absolute Glacier Prison",   "dmg_min": 185, "dmg_max": 240, "sta_cost": 130, "effect": "freeze_apply",  "desc": "Freeze + 30% dmg bonus on next form", "unlock_rank": "Upper Moon 4", "hits": 2},
        {"form": 12, "name": "Thousand Ice Needles",      "dmg_min": 200, "dmg_max": 260, "sta_cost": 145, "effect": "ice_bleed",     "desc": "Bleed: 15 DOT × 3 turns + 12% crit bonus this battle", "unlock_rank": "Upper Moon 3", "hits": 3},
        {"form": 13, "name": "Eternal Winter Domain",     "dmg_min": 220, "dmg_max": 285, "sta_cost": 160, "effect": "ice_shatter",   "desc": "AOE: DEF -20 for 4 turns + Frostburn applied", "unlock_rank": "Upper Moon 3"},
        {"form": 14, "name": "Soul of the Glacier",       "dmg_min": 250, "dmg_max": 320, "sta_cost": 185, "effect": "frostburn",     "desc": "Frostburn 15 STA/t × 4 turns + 20% crit boost", "unlock_rank": "Upper Moon 2"},
        {"form": 15, "name": "Absolute Zero: World End",  "dmg_min": 300, "dmg_max": 400, "sta_cost": 220, "effect": "deep_freeze",   "desc": "ULTIMATE: Deep Freeze + Frostburn + Shatter simultaneously", "unlock_rank": "Upper Moon 1"},
    ],
    "Shockwave Martial Art": [
        {"form": 1, "name": "Destructive Death: Compass Needle",  "dmg_min": 60, "dmg_max": 78, "sta_cost": 22},
        {"form": 2, "name": "Destructive Death: Annihilation",    "dmg_min": 70, "dmg_max": 90, "sta_cost": 30},
        {"form": 3, "name": "Destructive Death: Frenzy",          "dmg_min": 80, "dmg_max": 102, "sta_cost": 38, "hits": 2},
        {"form": 4, "name": "Eight Layered Demon Core",           "dmg_min": 100, "dmg_max": 128, "sta_cost": 55, "unlock_rank": "Upper Moon 6"},
    ],
    "Poison Demon Art": [
        {"form": 1, "name": "Venom Slash",              "dmg_min": 38, "dmg_max": 52, "sta_cost": 16, "poison": True, "effect": "poison_apply"},
        {"form": 2, "name": "Toxic Cloud",              "dmg_min": 45, "dmg_max": 60, "sta_cost": 22, "poison": True, "effect": "poison_aoe"},
        {"form": 3, "name": "Necrotic Flood",           "dmg_min": 58, "dmg_max": 76, "sta_cost": 28, "poison": True},
        {"form": 4, "name": "Death Miasma",             "dmg_min": 75, "dmg_max": 96, "sta_cost": 40, "poison": True, "unlock_rank": "Lower Moon 3"},
    ],

    # ── ULTRA LEGENDARY ──────────────────────────────────────────────────
    "Absolute Biokinesis": [
        {"form": 1, "name": "Blood Cell Reconstruction",  "dmg_min": 90,  "dmg_max": 115, "sta_cost": 30, "effect": "regen"},
        {"form": 2, "name": "Flesh Fortress",             "dmg_min": 100, "dmg_max": 130, "sta_cost": 35, "effect": "barrier"},
        {"form": 3, "name": "Cellular Annihilation",      "dmg_min": 120, "dmg_max": 155, "sta_cost": 45, "effect": "poison_apply"},
        {"form": 4, "name": "Morphic Catastrophe",        "dmg_min": 140, "dmg_max": 180, "sta_cost": 55, "unlock_rank": "Upper Moon 3"},
        {"form": 5, "name": "Demon King's Domain",        "dmg_min": 180, "dmg_max": 230, "sta_cost": 80, "unlock_rank": "Upper Moon 1"},
    ],
    ...
    "Thunder Breathing": [
        {"form": 1, "name": "Thunderclap and Flash",     "dmg_min": 50, "dmg_max": 65, "sta_cost": 20, "type": "opener",
         "desc": "Blinding speed strike — 20% chance to Stun enemy."},
        {"form": 2, "name": "Rice Spirit",               "dmg_min": 40, "dmg_max": 55, "sta_cost": 18, "type": "multi",   "hits": 2,
         "desc": "Two rapid slashes — each hit stacks pressure."},
        {"form": 3, "name": "Thunder Swarm",             "dmg_min": 35, "dmg_max": 50, "sta_cost": 22, "type": "barrage", "hits": 3,
         "desc": "Three rapid hits — deals bonus damage against stunned enemies."},
        {"form": 5, "name": "Heat Lightning",            "dmg_min": 60, "dmg_max": 78, "sta_cost": 32, "type": "punish",  "unlock_rank": "Kinoe",
         "desc": "Unleashes lightning pressure — reduces enemy SPD for 2 turns."},
        {"form": 6, "name": "Rumble and Flash",          "dmg_min": 70, "dmg_max": 90, "sta_cost": 45, "type": "finisher","unlock_rank": "Kinoe",
         "desc": "Thunder + speed combo — 40% Stun chance on hit.", "effect": "stun_chance"},
        {"form": 7, "name": "Honoikazuchi no Kami",      "dmg_min": 95, "dmg_max": 120,"sta_cost": 65, "type": "ultimate","unlock_rank": "Hashira",
    ...
    "Wind Breathing": [
        ...
        {"form": 3, "name": "Clean Storm Wind Tree",     "dmg_min": 40, "dmg_max": 55, "sta_cost": 22, "type": "control",
         "desc": "Spinning wind strike — 30% chance to Exhaust enemy.", "effect": "exhaust_chance"},
        {"form": 4, "name": "Rising Winds",              "dmg_min": 50, "dmg_max": 65, "sta_cost": 28, "type": "chase",   "unlock_rank": "Kinoe",
         "desc": "Ascending storm — bonus damage if used after Form 3."},
        {"form": 5, "name": "Gale Storm Slash",          "dmg_min": 60, "dmg_max": 78, "sta_cost": 35, "type": "barrage", "hits": 3, "unlock_rank": "Kinoe",
         "desc": "Three-hit storm barrage — each hit deals wind pressure damage."},
        {"form": 9, "name": "Idaten Typhoon",            "dmg_min": 85, "dmg_max": 105,"sta_cost": 60, "type": "ultimate","unlock_rank": "Hashira",
         "desc": "God of Wind — hurricane damage with 50% Exhaust.", "effect": "exhaust_apply"},
    ],

    # Stone Breathing (add Forms 3-7)
    "Stone Breathing": [
        {"form": 1, "name": "Serpentinite Bipolar",      "dmg_min": 45, "dmg_max": 58, "sta_cost": 20, "type": "opener",
         "desc": "Two-direction split strike — high base damage."},
        {"form": 2, "name": "Volcanic Rock Rapid Conquest","dmg_min": 40, "dmg_max": 55,"sta_cost": 18, "type": "barrage","hits": 2,
         "desc": "Rapid stone strikes — each hit reduces enemy DEF."},
        {"form": 3, "name": "Stone Skin",                "dmg_min": 35, "dmg_max": 50, "sta_cost": 22, "type": "defensive",
         "desc": "Harden skin — reduce all incoming damage by 20% for 3 turns.", "effect": "def_buff"},
        {"form": 4, "name": "Crushing Boulder",         "dmg_min": 55, "dmg_max": 72, "sta_cost": 28, "type": "punish",  "unlock_rank": "Kinoe",
         "desc": "Massive impact — 35% chance to Stagger enemy.", "effect": "stagger_chance"},
        {"form": 5, "name": "Arcs of Justice",          "dmg_min": 75, "dmg_max": 95, "sta_cost": 50, "type": "finisher","unlock_rank": "Kinoe",
         "desc": "Devastating arc slash — extra damage when enemy is staggered."},
        {"form": 6, "name": "Mountainous Avalanche",    "dmg_min": 90, "dmg_max": 115,"sta_cost": 60, "type": "ultimate","unlock_rank": "Hashira",
         "desc": "Unleash a mountain's force — guaranteed Stagger + massive damage.", "effect": "stagger_apply"},
    ],

    # Serpent Breathing (add Forms 4-6)
    "Serpent Breathing": [
        {"form": 1, "name": "Winding Serpent Slash",    "dmg_min": 38, "dmg_max": 52, "sta_cost": 18, "type": "opener",
         "desc": "Deceptive curved strike — applies Vulnerable 25%."},
        {"form": 2, "name": "Venom Fangs of Narrow Eyes","dmg_min": 42, "dmg_max": 56,"sta_cost": 22, "type": "poison",   "effect": "poison_apply",
        ...
        {"form": 4, "name": "Twin Headed Reptile",      "dmg_min": 52, "dmg_max": 68, "sta_cost": 28, "type": "multi",    "hits": 2, "unlock_rank": "Kinoe",
         "desc": "Double-headed strike — 2 hits, each can apply Poison."},
        {"form": 5, "name": "Slithering Viper",         "dmg_min": 65, "dmg_max": 82, "sta_cost": 38, "type": "finisher", "unlock_rank": "Kinoe",
         "desc": "Rapid serpent lunge — bonus damage per Poison stack active."},
        {"form": 6, "name": "King Cobra",               "dmg_min": 85, "dmg_max": 105,"sta_cost": 55, "type": "ultimate", "effect": "deep_poison", "unlock_rank": "Hashira",
         "desc": "Lethal bite — applies Deep Poison (5%/turn × 4 turns).", },
    ],

    # Mist Breathing (add Forms 3-7)
    "Mist Breathing": [
        {"form": 1, "name": "Low Clouds Distant Haze",  "dmg_min": 35, "dmg_max": 50, "sta_cost": 15, "type": "opener",
         "desc": "Deceptive invisible slash — 25% Confusion chance.", "effect": "confuse_chance"},
        {"form": 2, "name": "Eight Layered Mist",       "dmg_min": 40, "dmg_max": 55, "sta_cost": 20, "type": "multi",    "hits": 2,
         "desc": "Layered phantom strikes — hard to dodge."},
        {"form": 3, "name": "Scattering Mist Splash",   "dmg_min": 45, "dmg_max": 60, "sta_cost": 25, "type": "control",  "effect": "confuse_apply",
         "desc": "Disorienting mist — applies Confusion (2 turns).", "unlock_rank": "Kinoe"},
        {"form": 4, "name": "Shifting Flow Slash",      "dmg_min": 55, "dmg_max": 72, "sta_cost": 30, "type": "evasive",  "unlock_rank": "Kinoe",
         "desc": "Strike from the mist — +20% dodge rate this turn."},
        {"form": 5, "name": "Sea of Mist and Mountains","dmg_min": 65, "dmg_max": 83, "sta_cost": 38, "type": "control",  "unlock_rank": "Kinoe",
         "desc": "Dense mist — Confuses enemy and reduces their ATK 15%."},
        {"form": 6, "name": "Scattering Mist Slash",    "dmg_min": 70, "dmg_max": 88, "sta_cost": 45, "type": "finisher", "unlock_rank": "Kinoe"},
        {"form": 7, "name": "Obscuring Clouds",         "dmg_min": 80, "dmg_max": 100,"sta_cost": 55, "type": "ultimate", "effect": "confuse_apply", "unlock_rank": "Hashira",
         "desc": "Total obscurity — Confusion + Exhaust combo."},
    ],

    # Love Breathing (add Forms 3-8)
    "Love Breathing": [
        {"form": 1, "name": "Shivers of First Love",    "dmg_min": 50, "dmg_max": 65, "sta_cost": 22, "type": "opener",
         "desc": "Passionate opener — applies Vulnerable 30%."},
        {"form": 2, "name": "Love Pangs",               "dmg_min": 55, "dmg_max": 70, "sta_cost": 25, "type": "multi",    "hits": 2,
         "desc": "Double heartbeat — two strikes with fire intent."},
        {"form": 3, "name": "Anguish",                  "dmg_min": 60, "dmg_max": 78, "sta_cost": 30, "type": "punish",
         "desc": "Channel grief into power — bonus dmg if HP below 50%."},
        {"form": 4, "name": "Burning Passion",          "dmg_min": 65, "dmg_max": 83, "sta_cost": 35, "type": "buff",     "unlock_rank": "Kinoe",
         "desc": "Fiery resolve — +15% ATK for next 3 turns.", "effect": "atk_buff"},
        {"form": 5, "name": "Joyful Dance",             "dmg_min": 70, "dmg_max": 88, "sta_cost": 40, "type": "barrage",  "hits": 3, "unlock_rank": "Kinoe",
         "desc": "Spinning triple strike — dance of destruction."},
        {"form": 6, "name": "Cat Legged Winds of Love", "dmg_min": 75, "dmg_max": 95, "sta_cost": 48, "type": "finisher", "unlock_rank": "Hashira",
         "desc": "Ultimate love technique — inflicts Confusion on hit.", "effect": "confuse_apply"},
    ],

    # Sound Breathing (add Forms 2-4)
    "Sound Breathing": [
        {"form": 1, "name": "Roar",                     "dmg_min": 55, "dmg_max": 72, "sta_cost": 25, "type": "opener",   "effect": "exhaust_chance",
         "desc": "Ear-splitting roar — 30% chance to Exhaust enemy."},
        {"form": 2, "name": "Explosive Rush",           "dmg_min": 60, "dmg_max": 78, "sta_cost": 30, "type": "barrage",  "hits": 2,
         "desc": "Dual explosive slashes — shockwave with each hit."},
        {"form": 3, "name": "Warcry",                   "dmg_min": 50, "dmg_max": 68, "sta_cost": 28, "type": "buff",
         "desc": "Battle shout — raises own ATK +20% and Exhausts enemy.", "effect": "exhaust_apply"},
        {"form": 4, "name": "Constant Resounding Slashes","dmg_min": 65, "dmg_max": 82,"sta_cost": 35,"type": "barrage",  "hits": 3,
         "desc": "Three rapid sonic slashes — each reduces enemy STA."},
        {"form": 5, "name": "String Performance",       "dmg_min": 80, "dmg_max": 100,"sta_cost": 50, "type": "ultimate", "effect": "exhaust_apply", "unlock_rank": "Hashira",
    ...
    "Insect Breathing": [
        ...
        {"form": 2, "name": "Dance of the Bee Sting",   "dmg_min": 35, "dmg_max": 50, "sta_cost": 18, "type": "multi",    "hits": 2, "effect": "poison_apply", "poison": True,
         "desc": "Double sting — both hits can apply Poison."},
        {"form": 3, "name": "Dance of the Centipede",   "dmg_min": 40, "dmg_max": 55, "sta_cost": 22, "type": "barrage",  "hits": 3, "effect": "poison_apply", "poison": True,
         "desc": "Rapid multi-hit — each hit has poison chance."},
        {"form": 4, "name": "Dragonfly Dance",          "dmg_min": 45, "dmg_max": 60, "sta_cost": 25, "type": "evasive",  "poison": True,
         "desc": "Swift aerial — +20% dodge this turn, poisons on hit."},
        {"form": 5, "name": "Compound Eye Hexagon",     "dmg_min": 55, "dmg_max": 72, "sta_cost": 35, "type": "ultimate", "effect": "deep_poison",  "poison": True, "unlock_rank": "Hashira",
         "desc": "Full insect assault — applies Deep Poison.", },
    ],

    # Moon Breathing (add Forms 3-9)
    "Moon Breathing": [
        {"form": 1, "name": "Dark Moon Evening Palace", "dmg_min": 55, "dmg_max": 70, "sta_cost": 25, "type": "opener",   "effect": "freeze_apply",
         "desc": "Cold moonlit slash — 40% Freeze chance."},
        {"form": 2, "name": "Pearl Flower Moongazing",  "dmg_min": 60, "dmg_max": 75, "sta_cost": 28, "type": "multi",    "hits": 2,
         "desc": "Twin moon strikes — both can Freeze."},
        {"form": 3, "name": "Loathsome Moon Wolfbane",  "dmg_min": 65, "dmg_max": 82, "sta_cost": 32, "type": "control",  "effect": "freeze_apply",
         "desc": "Howling freeze — Freezes enemy (no techniques 2t)."},
        {"form": 4, "name": "Shifting Universe",        "dmg_min": 70, "dmg_max": 88, "sta_cost": 36, "type": "evasive",  "unlock_rank": "Kinoe",
         "desc": "Dimensional slash — +20% evasion this turn."},
        {"form": 5, "name": "Moon Spirit Calamitous Eddy","dmg_min": 80, "dmg_max": 100,"sta_cost": 50,"type": "finisher","unlock_rank": "Kinoe",
         "desc": "Spiraling moon energy — bonus damage if Freeze active."},
        {"form": 9, "name": "Waning Moonlit Slumber",   "dmg_min": 105,"dmg_max": 130,"sta_cost": 70, "type": "ultimate", "effect": "freeze_apply", "unlock_rank": "Hashira",
         "desc": "The ultimate moon form — guaranteed Freeze + massive cold damage."},
    ],

    # Sun Breathing (add Forms 4-12)
    "Sun Breathing": [
        {"form": 1, "name": "Dance",                    "dmg_min": 60, "dmg_max": 78, "sta_cost": 25, "type": "opener",
         "desc": "Flowing solar opener — cleanses 1 debuff on self."},
        {"form": 2, "name": "Clear Blue Sky",           "dmg_min": 65, "dmg_max": 82, "sta_cost": 28, "type": "multi",    "hits": 2,
         "desc": "Twin solar strikes — heavenly light."},
        {"form": 3, "name": "Raging Sun",               "dmg_min": 70, "dmg_max": 88, "sta_cost": 32, "type": "control",  "effect": "burn_apply",
         "desc": "Solar heat strike — applies Burn (90% chance)."},
        {"form": 4, "name": "Fake Rainbow",             "dmg_min": 75, "dmg_max": 93, "sta_cost": 36, "type": "evasive",  "unlock_rank": "Kinoe",
         "desc": "Illusory solar arc — +30% dodge this turn."},
        {"form": 5, "name": "Setting Sun Transformation","dmg_min": 80,"dmg_max": 100,"sta_cost": 42, "type": "punish",   "unlock_rank": "Kinoe",
         "desc": "Sunset slash — bonus damage if enemy HP below 60%."},
        {"form": 6, "name": "Solar Heat Haze",          "dmg_min": 85, "dmg_max": 105,"sta_cost": 48, "type": "control",  "effect": "confuse_apply", "unlock_rank": "Kinoe",
         "desc": "Mirage of the sun — Confusion on hit."},
        {"form": 7, "name": "Beneficent Radiance",      "dmg_min": 90, "dmg_max": 112,"sta_cost": 54, "type": "sustain",  "unlock_rank": "Kinoe",
         "desc": "Radiant light — heal 8% HP + cleanse 1 debuff."},
        {"form": 10, "name": "Sunflower Thrust",        "dmg_min": 95, "dmg_max": 120,"sta_cost": 58, "type": "barrage",  "hits": 3, "unlock_rank": "Hashira",
         "desc": "Piercing solar barrage — 3 hits of pure solar energy."},
        {"form": 12, "name": "Flame Dance",             "dmg_min": 100,"dmg_max": 130,"sta_cost": 70, "type": "ultimate", "effect": "burn_apply",    "unlock_rank": "Hashira",
         "desc": "The pinnacle Sun form — guaranteed Burn + execute damage."},
    ],

    # Flower Breathing (keep existing, add Forms 7+)
    "Flower Breathing": [
        {"form": 1, "name": "Scarlet Windflower",       "dmg_min": 38, "dmg_max": 52, "sta_cost": 16, "type": "opener"},
        {"form": 2, "name": "Honorable Shadow Plum",    "dmg_min": 42, "dmg_max": 58, "sta_cost": 20, "type": "multi",    "hits": 2},
        {"form": 3, "name": "Peonies of Futility",      "dmg_min": 48, "dmg_max": 65, "sta_cost": 24, "type": "control",  "effect": "confuse_chance"},
        {"form": 4, "name": "Crimson Hanagoromo",       "dmg_min": 56, "dmg_max": 72, "sta_cost": 30, "type": "punish",   "unlock_rank": "Kinoe"},
        {"form": 5, "name": "Peonies of Futility EX",  "dmg_min": 65, "dmg_max": 85, "sta_cost": 38, "type": "barrage",  "hits": 2, "unlock_rank": "Kinoe"},
        {"form": 6, "name": "Whirling Peach",           "dmg_min": 82, "dmg_max": 105,"sta_cost": 55, "type": "ultimate", "effect": "confuse_apply", "unlock_rank": "Hashira"},
    ],

    # Beast Breathing (keep existing, add Forms 7-10)
    "Beast Breathing": [
        {"form": 1, "name": "Sudden Throwing Strike",   "dmg_min": 40, "dmg_max": 55, "sta_cost": 18, "type": "opener"},
        {"form": 2, "name": "Hilt Strike",              "dmg_min": 38, "dmg_max": 52, "sta_cost": 16, "type": "stagger",  "effect": "stagger_chance"},
        {"form": 3, "name": "Devour",                   "dmg_min": 45, "dmg_max": 60, "sta_cost": 22, "type": "sustain",
         "desc": "Devour enemy life force — self-heal 5% HP."},
        {"form": 4, "name": "Slice and Dice",           "dmg_min": 50, "dmg_max": 66, "sta_cost": 25, "type": "barrage",  "hits": 2},
        {"form": 5, "name": "Crazy Cutting",            "dmg_min": 55, "dmg_max": 72, "sta_cost": 28, "type": "barrage",  "hits": 2, "unlock_rank": "Kinoe"},
        {"form": 6, "name": "Palisade Bite",            "dmg_min": 70, "dmg_max": 90, "sta_cost": 45, "type": "punish",   "unlock_rank": "Kinoe",
         "desc": "Savage bite — applies Bleed.", "effect": "bleed_apply"},
        {"form": 8, "name": "Explosive Rush",           "dmg_min": 80, "dmg_max": 100,"sta_cost": 55, "type": "chase",    "unlock_rank": "Kinoe"},
        {"form": 10, "name": "Whirling Fangs",          "dmg_min": 92, "dmg_max": 118,"sta_cost": 65, "type": "ultimate", "unlock_rank": "Hashira",
    ...
    "Spider Manipulation": [
        {"form": 1, "name": "Steel Thread Slash",       "dmg_min": 43, "dmg_max": 62, "sta_cost": 15, "type": "opener"},
        {"form": 2, "name": "Web Cocoon",               "dmg_min": 37, "dmg_max": 52, "sta_cost": 18, "type": "control",  "effect": "stagger_apply",
         "desc": "Encase in web — Staggers enemy."},
        {"form": 3, "name": "Spider Fang Barrage",      "dmg_min": 50, "dmg_max": 68, "sta_cost": 22, "type": "barrage",  "hits": 3,
         "desc": "Triple fang strike — each can apply Poison."},
        {"form": 4, "name": "Thread Manipulation",      "dmg_min": 55, "dmg_max": 73, "sta_cost": 28, "type": "control",  "effect": "freeze_apply",
         "desc": "Thread bind — prevents enemy technique use."},
        {"form": 5, "name": "Thousand Spider Army",     "dmg_min": 70, "dmg_max": 90, "sta_cost": 40, "type": "ultimate",
         "desc": "Unleash a swarm — massive multi-hit + Poison.", "effect": "poison_apply"},
    ],

    "Explosive Flames": [
        {"form": 1, "name": "Finger Bomb",              "dmg_min": 56, "dmg_max": 75, "sta_cost": 20, "type": "opener",   "effect": "burn_apply"},
        {"form": 2, "name": "Chain Explosion",          "dmg_min": 68, "dmg_max": 90, "sta_cost": 28, "type": "barrage",  "hits": 2, "effect": "burn_apply"},
        {"form": 3, "name": "Hellfire Blast",           "dmg_min": 87, "dmg_max": 112,"sta_cost": 40, "type": "finisher", "effect": "burn_apply",
         "desc": "Massive explosion — guaranteed Burn + max fire."},
        {"form": 4, "name": "Detonation Field",         "dmg_min": 75, "dmg_max": 95, "sta_cost": 35, "type": "control",  "effect": "exhaust_apply",
         "desc": "Explosive pressure — Exhausts enemy from shockwave."},
        {"form": 5, "name": "Armageddon Blast",         "dmg_min": 100,"dmg_max": 130,"sta_cost": 60, "type": "ultimate", "effect": "burn_apply",
         "desc": "Total annihilation — Burn + Stagger + execute chance."},
    ],

    "Corpse Puppeteering": [
        {"form": 1, "name": "Dead Man Slash",           "dmg_min": 47, "dmg_max": 65, "sta_cost": 18, "type": "opener"},
        {"form": 2, "name": "Puppet Barrage",           "dmg_min": 56, "dmg_max": 75, "sta_cost": 25, "type": "barrage",  "hits": 3},
        {"form": 3, "name": "Army of the Dead",         "dmg_min": 75, "dmg_max": 100,"sta_cost": 38, "type": "sustain",
         "desc": "Raise the dead — 10% HP regen per turn for 3 turns.", "effect": "regen_apply"},
        {"form": 4, "name": "Corpse Shield",            "dmg_min": 40, "dmg_max": 55, "sta_cost": 22, "type": "defensive",
         "desc": "Shield yourself with corpses — block next 2 hits."},
        {"form": 5, "name": "Death March",              "dmg_min": 90, "dmg_max": 115,"sta_cost": 55, "type": "ultimate",  "effect": "curse_apply",
         "desc": "Send the army — Curse + heavy damage."},
    ],

    "Water Manipulation": [
        {"form": 1, "name": "Water Whip",               "dmg_min": 43, "dmg_max": 60, "sta_cost": 15, "type": "opener"},
        {"form": 2, "name": "Tidal Crush",              "dmg_min": 56, "dmg_max": 75, "sta_cost": 22, "type": "punish",   "effect": "stagger_chance"},
        {"form": 3, "name": "Tsunami Strike",           "dmg_min": 72, "dmg_max": 93, "sta_cost": 35, "type": "finisher",
         "desc": "Wave crash — bonus damage if enemy Staggered."},
        {"form": 4, "name": "Water Prison",             "dmg_min": 60, "dmg_max": 78, "sta_cost": 30, "type": "control",  "effect": "freeze_apply",
         "desc": "Water prison orb — Freezes enemy."},
        {"form": 5, "name": "Maelstrom",                "dmg_min": 85, "dmg_max": 110,"sta_cost": 50, "type": "ultimate", "effect": "exhaust_apply",
         "desc": "Raging vortex — Exhausts + Staggers enemy."},
    ],

    "Ink Manipulation": [
        {"form": 1, "name": "Ink Slash",                "dmg_min": 40, "dmg_max": 57, "sta_cost": 15, "type": "opener"},
        {"form": 2, "name": "Blind Flood",              "dmg_min": 47, "dmg_max": 65, "sta_cost": 20, "type": "control",  "effect": "confuse_apply",
         "desc": "Ink flood blinds enemy — Confusion 2 turns."},
        {"form": 3, "name": "Black Ocean",              "dmg_min": 62, "dmg_max": 81, "sta_cost": 30, "type": "control",  "effect": "exhaust_apply",
         "desc": "Drown in ink — Exhaust + bonus damage."},
        {"form": 4, "name": "Suffocation Wave",         "dmg_min": 70, "dmg_max": 90, "sta_cost": 38, "type": "barrage",  "hits": 2,
         "desc": "Ink barrage — dual smothering hits."},
        {"form": 5, "name": "Ink Dimension",            "dmg_min": 88, "dmg_max": 112,"sta_cost": 52, "type": "ultimate", "effect": "confuse_apply",
         "desc": "Inky void — Confusion + Exhaust + damage."},
    ],

    "Biokinesis": [
        {"form": 1, "name": "Flesh Blade",              "dmg_min": 68, "dmg_max": 87, "sta_cost": 25, "type": "opener"},
        {"form": 2, "name": "Body Spike Barrage",       "dmg_min": 75, "dmg_max": 97, "sta_cost": 30, "type": "barrage",  "hits": 3},
        {"form": 3, "name": "True Form Unleash",        "dmg_min": 106,"dmg_max": 137,"sta_cost": 55, "type": "finisher",
         "desc": "Unleash demon body — massive dmg."},
        {"form": 4, "name": "Cell Regeneration",        "dmg_min": 40, "dmg_max": 55, "sta_cost": 20, "type": "sustain",
         "desc": "Regenerate cells — heal 12% HP.", "effect": "regen_apply"},
        {"form": 5, "name": "Flesh Fortress",           "dmg_min": 85, "dmg_max": 110,"sta_cost": 50, "type": "defensive",
         "desc": "Armored flesh — reduce incoming damage 25% for 2 turns."},
    ],

    "Spatial Warping": [
        {"form": 1, "name": "Dimensional Slash",        "dmg_min": 62, "dmg_max": 85, "sta_cost": 25, "type": "opener",   "effect": "confuse_chance"},
        {"form": 2, "name": "Space Collapse",           "dmg_min": 75, "dmg_max": 97, "sta_cost": 32, "type": "control",  "effect": "confuse_apply",
         "desc": "Collapse space — Confusion 2 turns."},
        {"form": 3, "name": "Void Rend",                "dmg_min": 93, "dmg_max": 118,"sta_cost": 45, "type": "finisher",
         "desc": "Tear open reality — bonus vs Confused enemies."},
        {"form": 4, "name": "Dimensional Prison",       "dmg_min": 80, "dmg_max": 103,"sta_cost": 40, "type": "control",  "effect": "freeze_apply",
         "desc": "Trap in space — Freeze enemy.", "unlock_rank": "Upper Moon 6"},
        {"form": 5, "name": "Reality Erasure",          "dmg_min": 110,"dmg_max": 140,"sta_cost": 65, "type": "ultimate", "effect": "confuse_apply",
